      ...
      try {
        ...
        try {
          const statsResponse = await axios.get<DashboardStats>(
            `https://egbackend-6zw2.onrender.com/api/dashboard/stats`, 
            { headers }
          )
        ...
        try {
          const jobsResponse = await axios.get<Job[]>(
            `https://egbackend-6zw2.onrender.com/api/dashboard/jobs/recent`, 
            { headers }
          )
        ...
        try {
          const applicationsResponse = await axios.get<Application[]>(
            `https://egbackend-6zw2.onrender.com/api/dashboard/applications/recent`, 
            { headers }
          )
        ...
        try {
          const paymentsResponse = await axios.get<Payment[]>(
                `https://egbackend-6zw2.onrender.com/api/dashboard/payments/recent`, 
            { headers }
          )
