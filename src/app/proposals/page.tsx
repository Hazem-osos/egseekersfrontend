...
const ProposalsPage = () => {
  ...
  const fetchUnreadNotifications = async () => {
    try {
      ...
      const response = await axios.get('https://egbackend-6zw2.onrender.com/api/notifications/unread/count', {
  ...
  const fetchProposals = async () => {
    try {
      ...
      const userResponse = await axios.get(`https://egbackend-6zw2.onrender.com/api/users/profile`, {
        headers: { Authorization: `Bearer ${token}` }
      });
      ...
      const response = await axios.get(`https://egbackend-6zw2.onrender.com/api/proposals/freelancer/${userId}`, {
        headers: { Authorization: `Bearer ${token}` }
      });
