    ...
    const fetchProposalAndUser = async () => {
      try {
        ...
        const proposalResponse = await axios.get(
          `https://egbackend-6zw2.onrender.com/api/proposals/${params.proposalId}`,
          { 
            headers: { 
  ...
  const handleUpdateStatus = async (newStatus: string) => {
    try {
      ...
      const endpoint = newStatus === 'ACCEPTED' 
        ? `https://egbackend-6zw2.onrender.com/api/proposals/${params.proposalId}/accept`
          : `https://egbackend-6zw2.onrender.com/api/proposals/${params.proposalId}/reject`;
