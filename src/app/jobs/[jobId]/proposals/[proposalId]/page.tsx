    ...
    const fetchProposalAndUser = async () => {
      try {
        ...
        const proposalResponse = await axios.get(
          `https://egbackend-1urid4jsb-hazemosama2553-gmailcoms-projects.vercel.app/api/proposals/${params.proposalId}`,
          { 
            headers: { 
  ...
  const handleUpdateStatus = async (newStatus: string) => {
    try {
      ...
      const endpoint = newStatus === 'ACCEPTED' 
        ? `https://egbackend-1urid4jsb-hazemosama2553-gmailcoms-projects.vercel.app/api/proposals/${params.proposalId}/accept`
          : `https://egbackend-1urid4jsb-hazemosama2553-gmailcoms-projects.vercel.app/api/proposals/${params.proposalId}/reject`;
