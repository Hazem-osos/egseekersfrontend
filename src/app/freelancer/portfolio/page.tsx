...
export default function PortfolioPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingItem) {
        await axios.put(`https://egbackend-6zw2.onrender.com/api/portfolio/${editingItem.id}`, formDataToSend, {
          headers: { 
        ...
        await axios.post('https://egbackend-6zw2.onrender.com/api/portfolio', formDataToSend, {
          headers: { 
            Authorization: `Bearer ${token}`,
            'Content-Type': 'multipart/form-data'
          }
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
        await axios.delete(`https://egbackend-6zw2.onrender.com/api/portfolio/${id}`, {
        headers: { Authorization: `Bearer ${token}` }
      })
